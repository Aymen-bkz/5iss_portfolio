        ...
        <div className='Home'>
            <Container fluid={true}>
                ...
                <Row>
                    ...
                    <div className='d-flex justify-content-center position-relative text-light-gray' style={{fontSize: "xxx-large"}}>
                        <FadeIn transitionDuration={300} delay={1800}><BsFillArrowDownSquareFill></BsFillArrowDownSquareFill></FadeIn>
